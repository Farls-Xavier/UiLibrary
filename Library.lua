...
--[[ :EXAMPLE
    ...
    Window:Tab({
        Text = "Home",
        Icon = "rbxassetid://13848371774",
        Size = Udim2.new(0,0,0,0) -- Image icons size for when its scaled incorrectly
    })

    For multiple tabs I recommend doing a table like this:

    local Tabs = {
	    ["Home"] = Window:Tab({Text = "Home", Icon = "rbxassetid://13848371774"}, UDim2.new(0, 20, 0, 20)),
	    ["Test"] = Window:Tab({Text = "Test", Icon = ""})
    }
]]
